...
const educationalItems = [
  {
    year: "September 2019 – October 2023",
    title: "BSc. Information Technology",
    description: "Ghana Communication Technology University – Accra, Ghana",
  },
  {
    year: "September 2009 – November 2012",
    title: "Advanced Diploma in Accounting and Finance",
    description: "Institute of Commercial Management (ICM-UK)",
  },
]

function Timeline({ items }: { items: typeof professionalItems }) {
              ...
              {items.map((item, index) => (
                ...
                >
                  <div className="sm:w-1/2 flex items-center justify-center sm:justify-end sm:pr-8">
                    <div
                      ...
                      className={`
                        ...
                        ${active === index ? "bg-[#FFF8F2] border-l-4 sm:border-l-0 sm:border-r-4 border-primary dark:bg-[#2A1A0A]" : "bg-card hover:bg-card/80"}
                  ...
                  <div className="flex sm:w-9 justify-center my-4 sm:my-0">
                    <div className={`w-5 h-5 rounded-full border-4 ${active === index ? "bg-primary border-background" : "bg-primary/30 border-background"}`} />
                  </div>
        ...
        <div className="space-y-6">
          ...
          <Tabs defaultValue="professional" className="w-full">
            ...
            <TabsContent value="education">
              <Timeline items={educationalItems} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
